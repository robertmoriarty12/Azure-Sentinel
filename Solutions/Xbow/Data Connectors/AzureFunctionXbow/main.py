...
Pulls vulnerability findings and assessment activity from the XBOW API on a
...
SyncState = dict  # {"findings": {asset_id: last_updated_at}, "assessments": {asset_id: last_updated_at}}
...
def main(mytimer: func.TimerRequest) -> None:
    ...
    # ------------------------------------------------------------------
    # 4. Collect new/changed findings (with full enrichment)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 5. Collect new/changed assessments
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 6. Create Sentinel ingestion client
    # ------------------------------------------------------------------
    try:
    ...
    # ------------------------------------------------------------------
    # 8. Persist updated state (only after successful ingest)
    # ------------------------------------------------------------------
    save_state({
    ...
    logging.info(
        ...
        f"(elapsed: {elapsed:.1f}s, findings: {len(finding_events)}, assessments: {len(assessment_events)})"
    )
